...
export default function Navbar({ onMenuClick }: NavbarProps) {
  ...
  return (
    <header className="h-14 flex items-center justify-between px-4 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 flex-shrink-0 z-30 transition-colors duration-300">
      {/* Left */}
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden md:flex items-center">
          ...
          <input
            ...
            className="w-72 pl-9 pr-4 py-1.5 bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all"
          />
          <kbd className="absolute right-2 text-xs text-slate-500 bg-slate-200 dark:bg-slate-700/50 px-1.5 py-0.5 rounded">⌘K</kbd>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1">
          ...
          <select
            ...
            className="bg-transparent text-xs font-medium text-slate-900 dark:text-slate-200 focus:outline-none cursor-pointer"
          >
            <option value="en" className="bg-white text-slate-900 dark:bg-slate-900 dark:text-white">EN (English)</option>
            <option value="hi" className="bg-white text-slate-900 dark:bg-slate-900 dark:text-white">HI (हिन्दी)</option>
            <option value="gu" className="bg-white text-slate-900 dark:bg-slate-900 dark:text-white">GU (ગુજરાતી)</option>
          </select>
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white rounded-lg hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
          >
          ...
          <AnimatePresence>
            {notifOpen && (
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 w-96 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 overflow-hidden"
              >
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-800 dark:text-slate-200 hidden sm:block">Admin</span>
